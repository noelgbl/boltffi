---
title: "Types"
description: "Reference how Rust types map to Swift, Kotlin, and TypeScript in BoltFFI, including supported primitives, collections, and performance notes."
---
...
<TypeTable
  title="Integers"
  mappings={[
    { rust: "i8", swift: "Int8", kotlin: "Byte", typescript: "number" },
    { rust: "i16", swift: "Int16", kotlin: "Short", typescript: "number" },
    { rust: "i32", swift: "Int32", kotlin: "Int", typescript: "number" },
    { rust: "i64", swift: "Int64", kotlin: "Long", typescript: "bigint" },
    { rust: "u8", swift: "UInt8", kotlin: "UByte", typescript: "number" },
    { rust: "u16", swift: "UInt16", kotlin: "UShort", typescript: "number" },
    { rust: "u32", swift: "UInt32", kotlin: "UInt", typescript: "number" },
    { rust: "u64", swift: "UInt64", kotlin: "ULong", typescript: "bigint" },
  ]}
/>
...
<TypeTable
  ...
  mappings={[
    { rust: "f32", swift: "Float", kotlin: "Float", typescript: "number" },
    { rust: "f64", swift: "Double", kotlin: "Double", typescript: "number" },
    { rust: "bool", swift: "Bool", kotlin: "Boolean", typescript: "boolean" },
    { rust: "String", swift: "String", kotlin: "String", typescript: "string" },
  ]}
/>
...
<TypeTable
  title=""
  mappings={[
    { rust: "Vec<T>", swift: "[T]", kotlin: "List<T>", typescript: "T[]" },
    { rust: "Option<T>", swift: "T?", kotlin: "T?", typescript: "T | null" },
    { rust: "Result<T, E>", swift: "throws", kotlin: "throws", typescript: "throws" },
  ]}
/>
...
<TypeTable
  title=""
  mappings={[
    { rust: "Duration", swift: "TimeInterval", kotlin: "Duration", typescript: "Duration" },
    { rust: "SystemTime", swift: "Date", kotlin: "Instant", typescript: "Date" },
    { rust: "Uuid", swift: "UUID", kotlin: "UUID", typescript: "string" },
    { rust: "Url", swift: "URL", kotlin: "URI", typescript: "string" },
    { rust: "Vec<u8>", swift: "Data", kotlin: "ByteArray", typescript: "Uint8Array" },
  ]}
/>
...
<TypeTable
  ...
  mappings={[
    { rust: "std::time::Duration", swift: "TimeInterval", kotlin: "Duration", typescript: "Duration" },
    { rust: "std::time::SystemTime", swift: "Date", kotlin: "Instant", typescript: "Date" },
    { rust: "uuid::Uuid", swift: "UUID", kotlin: "UUID", typescript: "string" },
    { rust: "url::Url", swift: "URL", kotlin: "URI", typescript: "string" },
    { rust: "Vec<u8>", swift: "Data", kotlin: "ByteArray", typescript: "Uint8Array" },
  ]}
/>
...
`std::time::Duration` represents a span of time. BoltFFI encodes it as seconds plus nanoseconds (12 bytes total). Swift uses `TimeInterval` (a `Double` of seconds), Kotlin uses `java.time.Duration`, and TypeScript uses a `{ secs: bigint, nanos: number }` object.
...
`std::time::SystemTime` represents a point in time. BoltFFI encodes it as seconds since Unix epoch plus nanoseconds (12 bytes). Negative values represent times before 1970.
...
`uuid::Uuid` from the [uuid](https://crates.io/crates/uuid) crate maps to native UUID types in Swift and Kotlin. TypeScript receives it as a string since JavaScript has no built-in UUID type.
...
`url::Url` from the [url](https://crates.io/crates/url) crate maps to `URL` in Swift, `URI` in Kotlin, and `string` in TypeScript. The URL is serialized as its string representation.
...
`Vec<u8>` and `&[u8]` represent raw binary data. Unlike other collections, bytes get special treatment: they map to `Data` in Swift, `ByteArray` in Kotlin, and `Uint8Array` in TypeScript.
