---
title: "Async"
description: "Export async Rust functions and methods with BoltFFI and bridge futures to native async APIs in Swift, Kotlin, and TypeScript."
---
...
<CodeComparison
  title="Database client with async queries"
...
<CodeComparison
  title="Async function that can fail"
  rust={`#[export]
...
<CodeComparison
  title="Cancelling a long-running operation"
  rust={`#[export]
