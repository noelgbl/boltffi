...
pub fn run_init(options: InitOptions) -> Result<PathBuf> {
    ...
    println!("Created mobiFFI.toml");
    println!();
    println!("Next steps:");
    println!("  1. mobiFFI check     # verify your environment");
    println!("  2. mobiFFI generate  # generate bindings");
    println!("  3. mobiFFI build     # compile for targets");
